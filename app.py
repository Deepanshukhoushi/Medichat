...
#     print(f"Processing new query: {msg}")
...
#         error_message = "I'm having trouble answering that right now. Please try again with a different question."
#         # Cache error responses too to prevent repeated failures
