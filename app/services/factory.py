...
# --- Dummy Repositories for when Supabase is disabled ---
...
class DummyChatHistoryRepository(IChatHistoryRepository):
    ...
    def save_chat_message(self, session_id: str, user_id: str, role: str, content: str) -> None: pass
    def get_recent_messages(self, session_id: str, limit: int = 10) -> list[dict]: return []
...
class DummyUserRepository(IUserRepository):
    def create_user(self, email: str, password_hash: str) -> dict: return {"id": "dummy"}
...
class DummyFlashcardRepository(IFlashcardRepository):
    def list_decks(self, user_id: str) -> list[dict]: return []
...
class DummyQuizRepository(IQuizRepository):
    def list_sessions(self, user_id: str) -> list[dict]: return []
...
class ServiceFactory:
    ...
    def __init__(self, settings: AppSettings, session_manager: SessionManager):
        ...
        if self.persistence_enabled:
            ...
            self.supabase = None
            logger.warning("Persistence is DISABLED. Using dummy repositories.")
